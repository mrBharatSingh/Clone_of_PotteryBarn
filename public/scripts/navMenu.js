...
function ourValues() {
  return `<div id="navSecondHoverBox">
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/068/225.jpg" alt="">
        <p class="navheadBold">Quality & Craftsmanship </p>
        <p>True quality is designed for life</p>
        <p>and crafted to last ></p>
    </div>
    <div>
    ...
    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/2373/001/001.jpg" alt="">
        <p class="navheadBold">Partners For Progress</p>
        <p>We’re proud to support St. Jude</p>
        <p>Children’s Research Hospital® ></p>
    </div>
    <div class="navlineHeight">
        <p class="navheadBold">About Us</p>
        <p>Our Story</p>
    ...
    <div class="navlineHeight">
        ...
        <p>NAACP</p>
        <p> Jackie Robinson Foundation</p>
...
function sustainability() {
  return ` <div id="navSecondHoverBox">
    ...
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/024/977.jpg" alt="">
        <p class="navheadBold">Pottery Barn Renewed</p>

        <p>We're extending the lives of our products,</p>
        <p>and keeping them out of landfills > </p>
    </div>
    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202118/1149/001/003.jpg" alt="">
        <p class="navheadBold">3 Million Trees in 3 Years</p>
        <p>Join us in our newest initiative to</p>
        <p>protect and restore our forests ></p>
    </div>
    <div class="navlineHeight">
        <p class="navheadBold">Our Impact</p>
        <p>See Our Commitments</p>
        <p>3 Million Trees Initiative/p>

        <p class="navheadBold">Shop Sustainably</p>
        <p>Pottery Barn Renewed</p>
        <p>Organic</p>
        <p>Sustainably Sourced/p>
        <p>Fair Trade Certified</p>
        <p>Handcrafted</p>
        <p> Certified Nontoxic</p>
        <p>Shop All</p>
...
function design() {
  return `<div id="navSecondHoverBox">
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/069/224.jpg" alt="">
        <p class="navheadBold">Free Interior Design Services</p>

        <p>From our factories to your homes,</p>
        <p>we're making things more sustainably ></p>
    </div>
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/061/292.jpg" alt="">
        <p class="navheadBold">Your Holiday Home</p>

        <p>Our design experts can help bring</p>
        <p>the season home ></p>
    </div>
    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/028/438.jpg" alt="">
        <p class="navheadBold">Room Planner</p>
        <p>See how our products will look</p>
        <p>in your exact space ></p>
    </div>
    <div class="navlineHeight">
        <p class="navheadBold">Design Services</p>
        <p>Free Interior Design</p>
        <p>Installation Services</p>
        <p>Room Planner</p>
        <p>Start a Design Chat</p>
        <p class="navheadBold">Featured Projects</p>
        <p>Allison Holker-Boss</p>
        <p>Nastia Luikin</p>

    </div>

    <div class="navlineHeight">
        <p class="navheadBold">Design Resources</p>
        <p>Free Fabric Swatches</p>
        <p>Find the Right Size Rug</p>

        <p>How to Hang Artwork</p>
        <p>Designing a Gallery Wall</p>
        <p>The Lighting Guide</p>
        <p>Dining Table Buying Guide</p>
        <p>How to Style Your Windows</p>
        <p> The Upholstery Fabric Guide</p>
        <p>How to Choose Paint Colors</p>

    </div>

    <div class="navlineHeight">
        <p class="navheadBold">B2B Programs</p>
        <p>Overview</p>
        <p>Trade</p>
        <p>Contract</p>
...
function inspiration() {
  return ` <div id="navSecondHoverBox">
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202140/1851/001/002.jpg" alt="">
        <p class="navheadBold">The Holiday Lookbook</p>
        <p>Get inspired ></p>
    </div>

    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/056/722.jpg" alt="">
        <p class="navheadBold">Get The Look</p>
        <p>Shop Rooms ></p>


    </div>
    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202140/1851/001/003.jpg" alt="">
        <p class="navheadBold">Real-Life Style</p>
        <p>The Instagram Shop ></p>
    </div>

    <div class="navlineHeight">
        <p class="navheadBold">Lookbooks</p>
        <p>The Holiday Lookbook</p>
        <p>The Fall Lookbook</p>


    </div>

    <div class="navlineHeight">
        <p class="navheadBold">Shop Rooms</p>
        <p>Living Rooms</p>
        <p>Bedrooms</p>
    ...
    <div class="navlineHeight">
        <p class="navheadBold">Holiday Favorites</p>
        <p>Christmas Trees</p>
        <p>Holiday Mantels</p>
        <p>Front Doors</p>
        <p>Pillow Pairings</p>
...
function newNow() {
  return ` <div id="navSecondHoverBox">
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/067/144.jpg" alt="">
        <p class="navheadBold">New Holiday Arrivals</p>
        <p>Shop Now ></p>
    </div>

    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202140/1823/001/003.jpg" alt="">
        <p class="navheadBold">Trends We Love</p>
        <p>Shop Now ></p>


    </div>

    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202140/1823/001/001.jpg" alt="">
        <p class="navheadBold">Our Chief Design Officer's Picks</p>
        <p>Shop Now ></p>
    </div>

    <div class="navlineHeight">
        <p class="navheadBold">New Arrivals</p>
        <p>Shop All</p>
        <p>Bedding</p>
        <p>Bath</p>
        <p>Pillows & Decor</p>
    ...
    <div class="navlineHeight">
        <p class="navheadBold">Now Trending</p>
        <p>Gnome Sweet Gnome</p>
        <p>Glowing Decor</p>
        <p>The Plaid Shop</p>
        <p>Whimsical Pillows</p>
        <p>Winter Botanicals</p>
        <p>Shop All Trends</p>
...
function collaborations() {
  return `<div id="navSecondHoverBox">
    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/061/073.jpg" alt="">
        <p class="navheadBold">Monique Lhuillier</p>
        <p>Shop Now ></p>
    </div>

    <div>
        <img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/058/589.jpg" alt="">
        <p class="navheadBold">Disney Mickey Mouse</p>
        <p>Shop Now ></p>


    </div>

    <div><img src="https://assets.pbimgs.com/pbimgs/ab/images/dp/ecm/202141/1804/056/641.jpg" alt="">
        <p class="navheadBold">Peanuts®</p>
        <p>Shop Now ></p>
    </div>

    <div class="navlineHeight">
        <p class="navheadBold">Collaborations</p>
        <p>Monique Lhuillier</p>
        <p>Disney Mickey Mouse</p>
        <p>Peanuts®</p>
        <p>Airstream</p>
        <p>Rebecca Atwood</p>
        <p>Harry Potter™</p>
...
// ================Second navBar conponents =================================================

function furniture() {
  return `<div id="navFourthHoverBox">
...
function holidays() {
  return `<div id="navFourthHoverBox">
    <div id="navFourthHoverBox1">
        <div class="navforthImgDiv">
            <img src="https://assets.pbimgs.com/pbimgs/rk/images/dp/ecm/202141/1804/068/197.jpg" alt=""
                class="navforthImg">
            <p class="boldnav">Make It Merry</p>
            <p>The Christmas Shop ></p>
        </div>
        <div class="navforthImgDiv">
            <img src="https://assets.pbimgs.com/pbimgs/rk/images/dp/ecm/202145/0577/001/001.jpg" alt=""
                class="navforthImg">
            <p class="boldnav">Give Thoughtfully</p>
            <p>Gift Guides ></p>
        </div>
        <div class="navforthImgDiv">
            <img src="https://assets.pbimgs.com/pbimgs/rk/images/dp/ecm/202147/0894/001/001.jpg" alt=""
                class="navforthImg">
            <p class="boldnav">All In Good Cheer</p>
            <p>The New Year's Shop ></p>
        </div>
        <div>
            <ul>
...
function sale() {
  return ` <div id="navFourthHoverBox">
    <div id="navFourthHoverBox1">
        ...
        <div id="navSaleimgDiv">
            <img src="https://assets.pbimgs.com/pbimgs/rk/images/dp/ecm/202150/2858/001/001.jpg" alt=""
                class="navSaleimg">
            <p class="boldnav">Save on 1000s of Items</p>
            <p>Shop Now</p>
